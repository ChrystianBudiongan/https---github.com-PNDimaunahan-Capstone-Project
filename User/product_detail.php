      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <div class="mb-3">
              ...
              <i class="fas fa-shopping-basket fa-sm mx-1"></i> <?php echo $productDetails['quantity']; ?> in stock
          </div>
          ...
          <div class="row mb-4">
              <div class="col-md-4 col-6 mb-3">
                  ...
                  <div class="input-group mb-3" style="width: 170px;">
                      <button class="btn btn-white border border-secondary px-3" type="button" id="decrementButton">
                          <i class="fas fa-minus"></i>
                      </button>
                      <input type="text" id="quantityInput" class="form-control text-center border border-secondary" value="1" min="1"/>
                      <button id="incrementButton" class="btn btn-white border border-secondary px-3" type="button">
